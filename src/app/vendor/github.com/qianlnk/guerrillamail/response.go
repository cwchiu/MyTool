...
type CheckEmailList struct {
	MailID        interface{} `json:"mail_id"`
	MailFrom      string `json:"mail_from"`
	MailSubject   string `json:"mail_subject"`
	MailExcerpt   string `json:"mail_excerpt"`
	MailTimestamp interface{} `json:"mail_timestamp"`
	MailRead      interface{} `json:"mail_read"`
	MailDate      string `json:"mail_date"`
	Att           interface{} `json:"att"`
	MailSize      interface{} `json:"mail_size"`
}
...
type FetchEmailResponse struct {
	...
	SourceMailID  interface{}    `json:"source_mail_id"`
	ReplyTo       string    `json:"reply_to"`
	MailSize      interface{}    `json:"mail_size"`
	Ver           string    `json:"ver"`
