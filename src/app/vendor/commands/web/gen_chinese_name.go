...
func SetupGenChineseNameCommand(rootCmd *cobra.Command) {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			resp, _, err := request.Post("http://www.richyli.com/name/index.asp").Set("User-Agent", "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; WOW64; Trident/7.0; .NET4.0C; .NET4.0E; .NET CLR 2.0.50727; .NET CLR 3.0.30729; .NET CLR 3.5.30729)").Send(form_data).SetDebug(false).End()
			if err != nil {
				panic(err)
			}
			// fmt.Println(body)
